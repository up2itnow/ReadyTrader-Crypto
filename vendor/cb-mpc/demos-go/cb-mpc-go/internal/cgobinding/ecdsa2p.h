...
// ------------------------- Utilities -----------------------------------------
// NOTE: This serialization format is intended for short-term caching and local persistence.
// It should NOT be relied upon for long-term storage across cb-mpc versions.
int serialize_mpc_ecdsa2p_key(mpc_ecdsa2pc_key_ref* key, cmems_t* ser);
int deserialize_mpc_ecdsa2p_key(cmems_t ser, mpc_ecdsa2pc_key_ref* key);
